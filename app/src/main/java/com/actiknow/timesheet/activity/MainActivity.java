...
//                        new PrimaryDrawerItem ().withName ("Leave Portal beta").withIcon (FontAwesome.Icon.faw_star).withIdentifier (10).withSelectable (false).withTypeface (SetTypeFace.getTypeface (MainActivity.this)),
