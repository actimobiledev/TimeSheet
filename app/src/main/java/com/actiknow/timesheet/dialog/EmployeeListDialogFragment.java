...
public class EmployeeListDialogFragment extends DialogFragment {
    ...
    public static EmployeeListDialogFragment newInstance (String employees) {
        EmployeeListDialogFragment fragment = new EmployeeListDialogFragment ();
        Bundle args = new Bundle ();
        args.putString (AppConfigTags.EMPLOYEES, employees);
...
//        }
    ...
    private void initBundle () {
        ...
        employees = bundle.getString (AppConfigTags.EMPLOYEES);
    }
